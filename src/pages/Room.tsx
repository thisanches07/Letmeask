                    ...
                    return(
                        ...
                        >
                           {!question.isAnswered && (
                                ...
                                onClick={()=>handleLikeQuestion(question.id, question.likeId)}//o onClick espera sempre uma funcao, por isso precisa ser feito dessa forma, ja que o handleLikeQuestion(question.id) é a execução de uma função 
                                >
